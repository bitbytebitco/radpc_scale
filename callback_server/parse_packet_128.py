...
def parse_from_base64str(base64str):
    ...
    try:
        data = {
            ...
            '5VC': int.from_bytes(bytes_str[45:47], byteorder="big", signed=False)*ONE_BIT*CURRENT*2,
            ...
            'sem_fault_cnt':int(bytes_str[67:69].hex(), 16),
            'tile_00_inj_cnt':int(bytes_str[69:71].hex(), 16),
            'tile_01_inj_cnt':int(bytes_str[71:73].hex(), 16),
            'tile_02_inj_cnt':int(bytes_str[73:75].hex(), 16),
            'tile_03_inj_cnt':int(bytes_str[75:77].hex(), 16),
            'sem_inj_cnt':int(bytes_str[77:79].hex(), 16),
            'tile_00_chkpt_lag':int(bytes_str[79:81].hex(), 16),
            'tile_01_chkpt_lag':int(bytes_str[81:83].hex(), 16),
            'tile_02_chkpt_lag':int(bytes_str[83:85].hex(), 16),
            'tile_03_chkpt_lag':int(bytes_str[85:87].hex(), 16),
